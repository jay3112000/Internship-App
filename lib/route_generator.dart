...
import 'src/pages/delievery_selection.dart';
...
import 'src/pages/AddMoney.dart';
...
class RouteGenerator {
  static Route<dynamic> generateRoute(RouteSettings settings) {
    ...
    switch (settings.name) {
      ...
      case '/PayByATM':
        return MaterialPageRoute(builder: (_) => OrderSuccessWidget(routeArgument: RouteArgument(param: 'Pay by ATM')));
      case '/PayOnPickup':
      ...
      case '/Selection':
        return MaterialPageRoute(builder: (_) => DeleiverySelection());
      case '/Wallet':
