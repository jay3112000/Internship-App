...
import '../elements/PaymentMethodCashWidget.dart';
import '../elements/PaymentMethodATMWidget.dart';
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            ListView.separated(
              ...
              itemBuilder: (context, index) {
                return PaymentMethodCashtemWidget(paymentMethod: list.cashList.elementAt(0));
              },
            ),
            Padding(
              ...
              child: ListView.separated(
                ...
                itemBuilder: (context, index) {
                  return PaymentMethodAtmtemWidget(paymentMethod: list.cashList.elementAt(1));
                },
              ),
            ),
          ],
