...
class _OrderSuccessWidgetState extends StateMVC<OrderSuccessWidget> {
  ...
  void initState() {
    ...
    Provider.of<HomeProvider>(context, listen: false).emptycart();
    _con.listenForCarts();
    Provider.of<HomeProvider>(context, listen: false).pop == true
        ? Provider.of<HomeProvider>(context, listen: false).changepop()
        : null;
    _con.listenForCarts();
    super.initState();
  }
