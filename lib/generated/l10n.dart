...
class S {
  ...
  String get total_number_of_items {
    return Intl.message(
  ...
  String get address_change_alert {
    return Intl.message(
      'Address Change Alert',
      name: 'address_change_alert',
      desc: '',
      args: [],
    );
  }
  String get if_you_change_the_address_your_cart_will_be_emptied {
    return Intl.message(
      'If you change the address your cart will be emptied',
      name: 'if_you_change_the_address_your_cart_will_be_emptied',
      desc: '',
      args: [],
    );
  }
  String get would_you_like_to_approve_of_this_message {
    return Intl.message(
      'Would you like to approve of this message',
      name: 'would_you_like_to_approve_of_this_message',
      desc: '',
      args: [],
    );
  }
  ...
  String get cart_empty_alert {
    return Intl.message(
      'Cart Empty Alert',
      name: 'cart_empty_alert',
      desc: '',
      args: [],
    );
  }
  String get we_need_a_delivery_address {
    return Intl.message(
      'We need a delivery address',
      name: 'we_need_a_delivery_address',
      desc: '',
      args: [],
    );
  }
  ...
  String get delivering_to_this_location{
    return Intl.message(
      'Delivering to this location',
      name: 'delivering_to_this_location',
      desc: '',
      args: [],
    );
  }
  String get address_not_selected{
    return Intl.message(
      'Address not selected',
      name: 'address_not_selected',
      desc: '',
      args: [],
    );
  }
  String get delivery_not_available_at_this_moment{
    return Intl.message(
      'Delivery not Available at this Moment',
      name: 'delivery_not_available_at_this_moment!',
      desc: '',
      args: [],
    );
  }
  String get you_can_schedule_your_delivery{
    return Intl.message(
      'You can Schedule your Delivery',
      name: 'you_can_schedule_your_delivery',
      desc: '',
      args: [],
    );
  }
  ...
  String get click_to_get_change{
    return Intl.message(
      'Click to get change',
      name: 'click_to_get_change',
      desc: '',
      args: [],
    );
  }
  String get pay_by_ATM{
    return Intl.message(
      'Pay by ATM',
      name: 'pay_by_ATM',
      desc: '',
  ...
  String get click_to_pay_by_ATM{
    return Intl.message(
      'Click to pay by ATM',
      name: 'click_to_pay_by_ATM',
      desc: '',
      args: [],
    );
  }
  String get select_your_preferred_delivery_method{
    return Intl.message(
      'Select your preferred delivery method',
      name: 'select_your_preferred_delivery_method',
      desc: '',
      args: [],
    );
  }
  String get your_cart_will_be_emptied {
    return Intl.message(
      'Your cart will be emptied',
      name: 'your_cart_will_be_emptied',
      desc: '',
      args: [],
    );
  }
